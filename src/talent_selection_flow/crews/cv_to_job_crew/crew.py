...
from talent_selection_flow.crews.cv_to_job_crew.schemas.report import FinalReportModel, GapAnalysis, QuestionSet
...
class CVToJobCrew:
    ...
    def __init__(self) -> None:
        ...
        out_path = Path(os.getenv("REPORT_OUTPUT_PATH", "storage/reports/latest_report.md"))
    ...
    def write_report_task(self) -> Task:
        ...
        return Task(
            ...
            markdown=True,
            output_file="storage/reports/latest_report.md",
        )
